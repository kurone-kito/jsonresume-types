...
The numeric `<!-- jsonresume-types-autopilot-suitability: N -->`
...
`<!-- jsonresume-types-autopilot-suitability: N -->` authoring
convention:

```markdown
<!-- jsonresume-types-triage-verdict: <outcome> -->
```
...
`jsonresume-types-triage-verdict` marker. Apply the same
