...
2. When contributing to this repository,
   ...
   [Issues](https://github.com/kurone-kito/jsonresume-types/issues) or any
...
3. If your idea can be shown **with a minor fix, please use directly the
   [pull request](https://github.com/kurone-kito/jsonresume-types/pulls)**.
   - This repository sometimes operates with a one-to-one tie between pull
     requests and releases, which is **not required**. We welcome your pull
     requests.
