...
| ------------------------------------------------------------------- | ----------------------------------------------------------------------- |
| `idd-skill` in repo-name contexts                                   | `jsonresume-types`                                                      |
| `idd-skill` in marker-prefix contexts (e.g. `idd-skill-roadmap-id`) | `jsonresume-types`                                                      |
...
| **post-fix-validate** command string                                | `pnpm run lint:fix && pnpm run lint && pnpm run build && pnpm run test` |
...
- `audit-docs.mjs` enforces synchronization rules defined in
  `sync-manifest.json`
- Template copies use placeholders like `jsonresume-types` to support
